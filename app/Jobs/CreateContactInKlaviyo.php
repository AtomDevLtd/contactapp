...
class CreateContactInKlaviyo implements ShouldQueue, ShouldBeUnique
{
    ...
    public function handle()
    {
        ...
        if (
            ...
            $createdContact = $klaviyoClient->lists->addMembersToList(
                $catalogApiIntegration->syncable_external_id,
                [
                    new ProfileModel([
